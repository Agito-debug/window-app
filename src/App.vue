      ...
      >
        <form>
          ...
          <div>
            ...
            <svg
              class="w-5 absolute mt-2.5 ml-1.5"
            ...
            <select
              class="w-full border border-gray-300 px-3 py-2 rounded-lg shadow-sm focus:outline-none focus:border-green-500 focus:ring-0"
              v-model="videoSelect"
            ></select>
          </div>
          <div>
